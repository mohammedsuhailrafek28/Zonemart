...
export default async function AdminDashboardPage() {
  ...
  if (String(profile.role) !== "admin") redirect("/unauthorized");
  return <div className="ops-shell">
    ...
    <section className="ops-content"><span className="eyebrow">Protected operations shell</span><h1>Platform Overview</h1>
      <div className="notice"><strong>Admin backend unavailable.</strong> The current deployment has no admin aggregation APIs, so no platform data or actions are exposed.</div>
